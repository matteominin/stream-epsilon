 ...
 * specifically focusing on a Demo Movie RAG (Retrieval Augmented Generation)
 * workflow.
 * <ul>
...
public class WorkflowExecutionE2ETest extends BaseE2ETest {
        ...
        private IntentMetamodel createIntent() {
                ...
                // Mock the intent vector search as the index creation is not real time and it
                // is slow!
                                ...
                                LlmPort.builder().withKey("movies")
                                                ...
                                                .withSchema(PortSchema.builder().arraySchema(
                                                                PortSchema.builder().objectSchema(Map.of(
                                                                                "plot",
                                                                                PortSchema.builder().stringSchema()
                                                                                                .build(),
                                                                                "title",
                                                                                PortSchema.builder().stringSchema()
                                                                                                .build()))
        ...
        private EmbeddingsNodeMetamodel createEmbeddingsDbNode() {
                ...
                metamodel.setInputPorts(List.of(
                                EmbeddingsPort.builder().withKey("input")
                                                ...
                                                .withSchema(PortSchema.builder().stringSchema().withRequired(true)
                                                                .build())
                                                .build()));
        ...
        void testRAGWorkflowExecutionWithAllExplicitBindings() throws BadRequestException {
                ...
                workflowMetamodelService.createWorkflow(createWorkflowMetamodel(intent, gatewayNodeMetamodel,
                                embeddingsNodeMetamodel, dbNodeMetamodel, llmNodeMetamodel));
        ...
        void testRAGWorkflowExecutionWithoutExplicitBindings() throws BadRequestException {
                ...
                var workflowMetamodel = createWorkflowMetamodel(intent, gatewayNodeMetamodel, embeddingsNodeMetamodel,
                                dbNodeMetamodel, llmNodeMetamodel);

                // Remove all the bindings from the workflow's edges
                for (var edge : workflowMetamodel.getEdges())
                        edge.setBindings(null);
                ...
                // The service should be called 2 times as there are two missing explicit
                // bindings
                ...
                Optional<WorkflowMetamodel> updatedWorkflowOptional = workflowMetamodelService
                                .getWorkflowById(workflowMetamodel.getId());
